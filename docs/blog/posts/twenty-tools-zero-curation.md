...
authors:
  - nikhil
slug: multi-model-ai-tools-no-curation
...
|---|---|---|
| **Works with** | claude.ai, ChatGPT, Microsoft Copilot (4 platforms) | Claude Code |
...
Published across 3 registries (Chrome Web Store, VS Code Marketplace, Open VSX). No new platform to learn. No API keys. No subscription. Just install and your existing AI conversations get better.
...
- [Chrome Extension](https://chromewebstore.google.com/detail/recurate-annotator/nfkfbokpmmcdnhdpnhcbkppapnkcdphm) — works on claude.ai, ChatGPT, and Microsoft Copilot (consumer + enterprise)
- VS Code Extension: [Marketplace](https://marketplace.visualstudio.com/items?itemName=recurate.recurate-annotator-vscode) | [Open VSX](https://open-vsx.org/extension/recurate/recurate-annotator-vscode) — works with Claude Code
